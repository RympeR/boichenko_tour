...
urlpatterns = [
    ...
    path('status-retrieve-tour/<int:pk>', StatusRetrieveTourView.as_view(), name='status_retrieve'),
    path('status-retrieve-room/<int:pk>', StatusRetrieveRoomView.as_view(), name='status_retrieve'),
    path('status-retrieve-transfer/<int:pk>', StatusRetrieveTransferView.as_view(), name='status_retrieve'),
    path('change-password/', ChangePasswordView.as_view(), name='change_password'),
    path('info-retrieve-tour/<int:pk>', InfoRetrieveToursView.as_view(), name='info_retrieve_tour'),
    path('info-retrieve-room/<int:pk>', InfoRetrieveRoomView.as_view(), name='info_retrieve_room'),
    path('info-retrieve-transfer/<int:pk>', InfoRetrieveTransferView.as_view(), name='info_retrieve_transfer'),
