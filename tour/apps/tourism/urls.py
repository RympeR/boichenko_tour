...
urlpatterns = [
    ...
    path('order-transfer-client/', OrderClientTransferView.as_view(), name='order_transfer_client'),
    path('order-tour-client/', OrderClientTourView.as_view(), name='order_tour_client'),
    path('order-room-client/', OrderClientRoomView.as_view(), name='order_room_client'),
